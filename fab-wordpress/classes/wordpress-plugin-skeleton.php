	...
	class WordPress_Plugin_Skeleton extends WPPS_Module
	{
		...
		public static function load_resources()
		{
			wp_register_script(
				...
				plugins_url('http://javascript/wordpress-plugin-skeleton.js', dirname(__FILE__)),
				array('jquery'),
				self::VERSION,
				true
			);
			...
			wp_enqueue_script(self::PREFIX, 'bootstrap');
			wp_enqueue_style(self::PREFIX . 'bootstrap');
