(function() {
  ...
  GeoAreaDetailController.$inject = [
    '$log',
    '$translate',
    '$uibModalInstance',
    'toastr',
  ...
  function GeoAreaDetailController(
    $log,
    $translate,
    $uibModalInstance,
    toastr,
    ...
    ngTableEventsChannel.onAfterDataFiltered(function(
      filter,
      ngTable,
      filteredData
    ) {
    ...
    function addCitiesToDisplay(cities) {
      cities.forEach(function(city) {
        if (
          !lodash.find(vm.citiesToDisplay, {
            id: city.id
          })
        ) {
    ...
    vm.save = function(valid) {
      ...
      if (valid) {
        ...
        GeoAreaAPIService.save({}, vm.area)
