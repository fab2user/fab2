(function () {
  ...
  AuthService.$inject = ['$rootScope', '$http', '$log', '$sessionStorage', '$state', 'SERVER', 'STORE', 'EVENT'];
  // APIErrorInterceptor redirects to login page everytime we get forbidden status from the API
  function AuthService($rootScope, $http, $log, $sessionStorage, $state, SERVER, STORE, EVENT) {
    var AuthService = {};
