...
CREATE TABLE address (id BIGINT AUTO_INCREMENT NOT NULL, created_by BIGINT, created_on DATETIME, deleted TINYINT(1) default 0, address VARCHAR(255), modified_by BIGINT, modified_on DATETIME, name VARCHAR(255) NOT NULL, municipality BIGINT, PRIMARY KEY (id));
CREATE TABLE bailiff (id BIGINT AUTO_INCREMENT NOT NULL, created_by BIGINT, created_on DATETIME, deleted TINYINT(1) default 0, name VARCHAR(255) NOT NULL, modified_by BIGINT, modified_on DATETIME, phone VARCHAR(25), email VARCHAR(50), address BIGINT, PRIMARY KEY (id));
