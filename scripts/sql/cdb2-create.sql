...
CREATE TABLE address (id BIGINT AUTO_INCREMENT NOT NULL, created_by BIGINT, created_on DATETIME, deleted TINYINT(1) default 0, address VARCHAR(255), modified_by BIGINT, modified_on DATETIME, municipality BIGINT, phone VARCHAR(25), email VARCHAR(50), PRIMARY KEY (id));
CREATE TABLE bailiff (id BIGINT AUTO_INCREMENT NOT NULL, created_by BIGINT, created_on DATETIME, deleted TINYINT(1) default 0, name VARCHAR(255) NOT NULL, modified_by BIGINT, modified_on DATETIME, address BIGINT, PRIMARY KEY (id));
